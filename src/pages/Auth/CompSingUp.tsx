          ...
          <>
            ...
            >
              <Pressable
                ...
                style={{ width: responsiveWidth(2.8), aspectRatio: 1 / 2 }}
              >
                <Image
                  style={{ height: '100%', width: '100%' }}
            ...
            <InPutWithLabel
              inputContainerStyle={{ marginBottom: responsiveHeight(0.5) }}
              mainColor={mainColor}
              secondaryColor={secondaryColor}
              label={type === 'comp' ? 'Work Email' : 'Email address'}
              value={user.email}
              onChangeText={text =>
                handleInputChange({ name: 'email', value: text })
              }
              placeholder="Email"
            />
            <Text
            ...
            <InPutWithLabel
              inputContainerStyle={{ marginBottom: responsiveHeight(0.3) }}
              mainColor={mainColor}
              secondaryColor={secondaryColor}
              ...
              value={user.password}
              onChangeText={text =>
                handleInputChange({ name: 'password', value: text })
              }
            ...
            <InPutWithLabel
              ...
              onChangeText={text =>
                handleInputChange({ name: 'confirmPassword', value: text })
              }
              placeholder="Password"
            />
            ...
            >
              ...
              <CustomTextInput
                ...
                onChangeText={(text: string) =>
                  handleInputChange({ name: 'mobile', value: text })
                }
      ...
      case 2:
        return (
          <>
            ...
            >
              We sent a 6-digit code by email.
            </Text>
            <Text
              style={{
                color: colors.textSecondary,
            ...
            >
              ...
              {remainingSeconds === 0 ? (
                <Text
                  onPress={() => {
                    dispatch(RecruiterRecruiterReSentOtp({ email: user.email }))
                      .unwrap()
                      .then(res => {
                        if (res.success) {
                          startTimer();
            ...
            >
              Check your spam or junk folder before resending.
            </Text>
            ...
            <Pressable
              style={{
                width: responsiveWidth(90),
                marginTop: responsiveHeight(1.5),
                aspectRatio: 350 / 57.2,
              }}
            >
              <Image
                style={{ height: '100%', width: '100%', resizeMode: 'cover' }}
                source={require('./OpenEmailApp.png')}
              />
            </Pressable>
            <Pressable
              style={{
            ...
            >
              <Image
                style={{ height: '100%', width: '100%', resizeMode: 'cover' }}
                source={require('./NeverShareCode.png')}
              />
            </Pressable>
            <View style={{ flex: 1 }}></View>
            <Pressable
            ...
            <Button
              ...
              backgroundColor={mainColor}
              onPress={() => {
                console.log('Verify and continue');
              }}
            />
          </>
        );
