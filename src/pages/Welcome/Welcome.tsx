...
const WelcomeItem = React.memo(({ item }: { item: WelcomeScreenItem }) => {
  ...
  return (
    <View style={[styles.itemContainer, {  }]}>
      ...
      <Text style={[styles.description, { color: colors.white, lineHeight:responsiveScreenHeight(2.5) }]}>
...
const Welcome = () => {
  ...
  return (
    <>
      {
       false && <View style={{ opacity: .1, borderWidth: 1, position: "absolute", top: 0, height: responsiveScreenHeight(100), width: responsiveScreenWidth(100), left: 0, zIndex: 100, }}>
