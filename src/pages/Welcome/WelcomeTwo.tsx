...
export const SocialButton = React.memo(
  ({ logo, children, height = "auto", onPress = () => { } }: { logo: ImageSourcePropType; children?: ReactNode, height?: number | "auto" }) => {
    const { colors } = useContext(ThemeContext);
    return (
      <TouchableOpacity onPress={onPress} style={[styles.socialButton, { backgroundColor: colors.lightBlue, maxHeight: height }]}>
