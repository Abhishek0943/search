...
type StoryCreatorRouteProp = RouteProp<RootStackParamList, 'StoryCreate'>;
export default function StoryCreator() {
    ...
    const route = useRoute<StoryCreatorRouteProp>()
    const { url } = route.params
    const { colors } = useContext(ThemeContext);
    const color = ['#fff', '#000', '#ff4757', '#ffa502', '#2ed573', '#1e90ff', '#b71540'];
    const emojis = ['😊', '🔥', '🎉', '✨', '❤️', '😎', '🌈'];
    ...
    return (
        <View style={{ flex: 1, backgroundColor: colors.background }}>
            <View style={[styles.topBar, { paddingHorizontal: responsiveScreenWidth(2), paddingVertical: responsiveScreenHeight(1.8) }]}>
                <TouchableOpacity >
                    <Text style={{ color: colors.textPrimary, backgroundColor: colors.surfaces, paddingHorizontal: responsiveScreenWidth(3), paddingVertical: responsiveScreenHeight(.5), borderRadius: 6, fontSize: responsiveScreenFontSize(2), fontWeight: "500" }}>Cancel</Text>
                </TouchableOpacity>

            </View>

            <View style={{ width: responsiveScreenWidth(98), marginHorizontal: "auto", overflow: "hidden", borderRadius: 20, backgroundColor: colors.backgroundSecondary, aspectRatio: 9 / 15 }}>
            ...
            <View style={{ paddingHorizontal: responsiveScreenWidth(2), paddingVertical: responsiveScreenHeight(1.8) }}>
                <View style={styles.row}>
                    <TouchableOpacity style={styles.toolBtn} onPress={() => setItem("text")}>
            ...
            <Modal transparent style={{}} visible={!!item}>
