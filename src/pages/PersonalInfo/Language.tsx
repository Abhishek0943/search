...
function CvCard({
    ...
    return (
        ...
        <View style={[styles.card, { marginTop: responsiveScreenHeight(2), borderColor: colors.surfaces, backgroundColor: colors.lightGrayNatural, paddingHorizontal: responsiveScreenWidth(2), paddingVertical: responsiveScreenHeight(1), borderWidth: 1 }]}>
            <View style={styles.topRow}>
                ...
                <View style={styles.actions}>
                    ...
                    <Pressable onPress={async () => {
                        ...
                        if (ok) {
                            dispatch(DeleteUserLanguage({ id: id })).unwrap().then((e) => { if (e.success) { refresh() } })
                        }
            ...
            <Text style={[styles.subTitle, { fontSize: responsiveScreenFontSize(1.7), color: colors.textSecondary, fontWeight: "600", marginTop: responsiveScreenHeight(.8) }]}>{isDefault}</Text>
        </View>
