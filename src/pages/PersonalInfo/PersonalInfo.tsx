...
const PersonalInfo = () => {
  ...
  useEffect(() => {
    ...
    setFormData(prev => ({
      ...
      experience: data?.job_experience?.id ?? 0,
      careerLevel: data?.career_level?.id ?? 0,
      industry: data?.industry?.id ?? 0,
      functionalArea: data?.functional_area?.id ?? 0,
            ...
            <Pressable
              onPress={() => {
                ...
                if (!formData.experience) {
                  showAlert({
                    title: "Validation",
                    message: "Please select job experience",
                  });
                  return;
                }
...
export const CustomDropdown = ({
  ...
  return (
    <>
      ...
      >
        <View style={{ flex: 1, marginLeft: responsiveScreenWidth(2) }}>
        ...
        <View style={{ height: responsiveScreenHeight(2), marginRight: responsiveScreenWidth(2), minWidth: responsiveScreenWidth(4) }}>
          <Image source={imagePath.angle} style={{ width: "100%", }} />
        </View>
      </TouchableOpacity>
