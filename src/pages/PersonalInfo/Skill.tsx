import { ActivityIndicator, FlatList, Image, Pressable, ScrollView, StyleSheet,  TouchableWithoutFeedback, View } from 'react-native'
            ...
            <View style={styles.topRow}>
                ...
                <View style={styles.actions}>
                    ...
                    <Pressable onPress={async () => {
                        ...
                        if (ok) {
                            dispatch(DeleteUserSkill({ id: id })).unwrap().then((e) => { if (e.success) { refresh() } })
                        }
