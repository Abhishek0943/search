    ...
    return (
        <NavigationBar navigationBar={false}>
            <ScrollView style={{ flex: 1, paddingHorizontal: responsiveScreenWidth(2) }} contentContainerStyle={{ justifyContent: "flex-start" }}>
                <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center", borderBottomColor: colors.textDisabled, borderBottomWidth: .5, paddingBottom: responsiveScreenHeight(2) }}>
                    <Pressable >
                        <Image source={imagePath.backIcon} style={{ resizeMode: "contain", }} />
                    </Pressable>
                    <Text style={{ flex: 1, textAlign: "center", fontSize: responsiveScreenFontSize(2), color: colors.textPrimary, fontWeight: "600" }}>Company Details</Text>
                    <Image source={imagePath.backIcon} style={{ opacity: 0, resizeMode: "contain", }} />
                </View>
                <Text style={{ color: colors.textPrimary, fontSize: responsiveScreenFontSize(2.6), marginVertical: responsiveScreenHeight(1) }}>{job?.name}</Text>
                {
                ...
                <Text style={{ color: colors.textSecondary, fontSize: responsiveScreenFontSize(2.6), marginVertical: responsiveScreenHeight(1), marginBottom: 0 }}>About Company</Text>
                {
                    job?.description &&
                    <AutoHeightWebView html={job.description} />
                }
                <View style={{ borderBottomColor: colors.textDisabled, borderBottomWidth: .5, }}></View>
                <Text style={{ color: colors.textSecondary, fontSize: responsiveScreenFontSize(2.6), marginVertical: responsiveScreenHeight(1), marginBottom: 0 }}>Company details</Text>
                <View style={{ flexDirection: "row", marginTop: responsiveScreenHeight(1), rowGap: responsiveScreenHeight(1.54), flexWrap: "wrap", justifyContent: "space-between" }}>
                    {
                        job.is_verified &&
                        <View style={{ gap: responsiveScreenHeight(.5), width: "33%" }}>
                            <Image source={imagePath.verify} style={{ transform: [{ scale: 1.3 }], }} />
                            <Text style={{ fontSize: responsiveScreenFontSize(2.2), fontWeight: "700" }}>Verified</Text>
                    ...
                    <View style={{ gap: responsiveScreenHeight(.5), width: "33%" }}>
                        ...
                        <Text style={{ fontSize: responsiveScreenFontSize(2.2), fontWeight: "700" }}>Company size</Text>
                        <Text style={{ color: colors.textSecondary, fontSize: responsiveScreenFontSize(2), }}>Yes</Text>
                    </View>
                    {
                        job.founded_at &&
                        <View style={{ gap: responsiveScreenHeight(.5), width: "33%" }}>
                            <Image source={imagePath.verify} style={{ transform: [{ scale: 1.3 }], }} />
                            <Text style={{ fontSize: responsiveScreenFontSize(2.2), fontWeight: "700" }}>Founded in</Text>
                    ...
                    }
                    {
                        ...
                        <View style={{ gap: responsiveScreenHeight(.5), width: "33%" }}>
                            ...
                            <Text style={{ fontSize: responsiveScreenFontSize(2.2), fontWeight: "700" }}>Organization
                                Type</Text>
                    ...
                    }
                    {
                        ...
                        <View style={{ gap: responsiveScreenHeight(.5), width: "33%" }}>
                            <Image source={imagePath.company2} style={{ transform: [{ scale: 1.3 }], }} />
                            <Text style={{ fontSize: responsiveScreenFontSize(2.4), fontWeight: "700" }}>Total Offices</Text>
                    ...
                    }
                    {
                        ...
                        <View style={{ gap: responsiveScreenHeight(.5), width: "33%" }}>
                            ...
                            <Text style={{ fontSize: responsiveScreenFontSize(2.2), fontWeight: "700" }}>Opened Jobs</Text>
                ...
                <Text style={{ color: colors.textSecondary, fontSize: responsiveScreenFontSize(2.6), marginVertical: responsiveScreenHeight(1), marginBottom: 0 }}>Current openings</Text>
