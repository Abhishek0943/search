    ...
    return (
        <NavigationBar name={routes.ACCOUNT}>
            ...
            >
                ...
                <TouchableOpacity onPress={() => logoutAndRestart()} style={{ width: "100%", marginHorizontal: "auto", flexDirection: "row", marginTop: responsiveScreenHeight(2), alignItems: "center", gap: responsiveScreenHeight(1) }}>
